# Execution Workspaces Core Agent Context
...
- Package root: `framework/builtin-plugins/execution-workspaces-core`
- Service layer: `framework/builtin-plugins/execution-workspaces-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/execution-workspaces-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/execution-workspaces-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/execution-workspaces-core/src/ui`

## Safe assumptions

- Use `execution-workspaces-core` as the stable plugin identifier and `@plugins/execution-workspaces-core` as the package import name.
