...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/execution-workspaces-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-execution-workspaces-core:");
...
console.log("Documentation check passed for gutu-plugin-execution-workspaces-core.");
